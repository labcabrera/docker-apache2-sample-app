...
.basic/resources/config/000-default.conf
----
include::basic/resources/config/000-default.conf[]
----
...
.basic/resources/config/sample-ssl.conf
----
include::ssl/resources/config/sample-ssl.conf[]
----
